...
## based on the Craft CMS starter package by Statik.be

This is a modified scaffolding package for Craft CMS, by [Statik.be](https://www.statik.be). We use this internally to start new projects.
edited by Jay Greentree for Greentree Radio
